...
//         
//         HackSkill hs = new HackSkill("Hardware Cracking", 0);
//         NPC npc = new NPC(1,"Router",3,"wireless-router-icon.png",hs);
//         System.out.println("NPC Number: "+rms_npc.writeNPCData(npc));
         
         
//         RMS_MazeMap objMazeMap = new RMS_MazeMap();
//         String strMap = "23, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 28,"+
...
//         int mapnumber = objMazeMap.writeMazeMapData(strMap);
//        
